...
const ParalaxBackground = dynamic(() => import('@/common/ui/parallax-background'), {
    ssr: false
})

const PanelCursorTrail = dynamic(() => import('@/components/CursorTrail'), {
    ssr: false
})

const PanelPortfolioBackgroundSection = dynamic(() => import('@/common/ui/architecture-background'), {
    ssr: false
})

export default function PanelPortfolio() {
                    ...
                    {item.isHero ? (
                      ...
                      backdrop-blur-2xl backdrop-saturate-150"
                        ...
                        <div className="bg-neutral-900 panel-content h-full w-full flex items-center justify-center">
                            <PanelPortfolioBackgroundSection theme={"dark"} />
