                ...
                render={({ field, fieldState }) => (
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      rows={6}
                      aria-invalid={fieldState.invalid}
                      className="bg-white dark:bg-neutral-950/50 border-neutral-300 dark:border-neutral-800 text-neutral-900 dark:text-white min-h-37.5 resize-none focus-visible:ring-blue-500 transition-colors"
                    />
